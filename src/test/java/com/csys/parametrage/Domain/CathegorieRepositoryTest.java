...
public class CathegorieRepositoryTest {
    ...
    public void setup() {
        ...
        this.cathegorie.setPrestSejour(prestation);
    ...
    public void saveChambreShouldReturnTrue() {
        ...
        assertThat(cathegorieRepository.findAll().get(0).getDesignationAr()).isEqualTo("TEST");
        assertThat(cathegorieRepository.findAll().get(0).getPrestSejour().getDesignationAr()).isEqualTo("TEST");
    }
